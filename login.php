                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li><a href="./band.html">Bands</a></li>
                ...
                <div class="card-body">
                    ...
                    <form name="form" action="login.php" method="POST">
                      ...
                      <div class="input-group"> <?php if(isset($message)) { echo $message; } ?>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" onclick="validateForm()">Log In</button>
                            <div>
                              <br>
                            </div>
                        <h3 class="input--style-3">Don't have an account? Sign Up</h3>



                        <div class="p-t-10">
                            <button class="btn btn--pill2 btn--red" type="login">Sign In</button>
                        </div>
                    </form>
                </div>
            </div>
